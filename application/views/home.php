	...
	<body>
		...
		<header id="home">
			...
			<div id="home-owl" class="owl-carousel owl-theme">
				...
				<div class="home-item">
					<!-- section background -->
					<div class="section-bg" style="background-image: url(assets/img/background-1.jpg);"></div>
					<!-- /section background -->
		...
		<div id="cta" class="section">
			<!-- background section -->
			<div class="section-bg" style="background-image: url(assets/img/background-1.jpg);" data-stellar-background-ratio="0.5"></div>
			<!-- /background section -->

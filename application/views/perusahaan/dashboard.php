...
<head>
	...
	<title><?php echo $this->session->userdata('nama'); ?> - Dashboard</title>
	...
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		...
		<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
			<ul class="nav menu">
				...
				<?php if($notif_spj == 1){ ?>
					<li><a href="<?php echo base_url('panel_perusahaan/dashboard/list_spj'); ?>"><em class="fa fa-envelope-open">&nbsp;</em> List SPJ &nbsp;<span class="label label-danger"><?php echo $notif_spj; ?></span></a></li>

...
<head>
	...
	<title>Admin - Akun Perusahaan</title>
					...
					<div class="panel panel-primary">
						...
						if ($data["status"] == "terverifikasi") { ?>
							...
							<?php } elseif ($data["status"] == "belum terverifikasi") { ?>
								<form style="text-align: center;" class="col-md-6" method="POST" action="<?php echo base_url('admin/verif_akun/do_verif_perusahaan') ?>">

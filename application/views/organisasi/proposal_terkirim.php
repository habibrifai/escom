	...
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		...
		<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
			<ul class="nav menu">
				...
				<li><a href="<?php echo base_url('panel_organisasi/dashboard/edit_profil'); ?>"><em class="fa fa-envelope-open">&nbsp;</em> Profil organisasi</a></li>
				...
				<li><a href="<?php echo base_url('panel_organisasi/dashboard/'); ?>"><em class="fa fa-envelope-open">&nbsp;</em> Kirim SPJ</a></li>
			</ul>
		</div>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Proposal Terkirim</li>
			</ol>
		</div><!--/.row-->

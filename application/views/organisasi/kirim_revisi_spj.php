...
<body>
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<form enctype="multipart/form-data" action="<?php echo base_url('panel_organisasi/dashboard/upload_revisi_spj')?>" method="POST">

				<div class="form-group row">
					<label for="inputEmail3" class="col-sm-2 col-form-label">Nama Perusahaan</label>
					<div class="col-sm-10">
						<input type="hidden" name="id_spj" value="<?php echo $data['id_spj']; ?>">

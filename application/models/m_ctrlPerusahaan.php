...
class M_ctrlPerusahaan extends CI_Model{
	...
	function get_spj($username){
		...
		$this->db->select('spj, proposal, id_perusahaan, status_spj, nama_organisasi');
		$this->db->from('spj');
		$this->db->join('proposal', 'proposal.id_proposal = spj.id_proposal');
		$this->db->join('organisasi', 'proposal.id_organisasi = organisasi.id_organisasi');
		$this->db->where('id_perusahaan', $hasil->id_perusahaan);
	...
	function get_proposal($username){
		...
		$this->db->select('id_proposal, id_perusahaan, nama_organisasi, proposal, tanggal_pengajuan, status_proposal, proposal.id_organisasi');
		$this->db->from('proposal');
		$this->db->join('organisasi', 'organisasi.id_organisasi = proposal.id_organisasi');
		$this->db->where('id_perusahaan', $hasil->id_perusahaan);
